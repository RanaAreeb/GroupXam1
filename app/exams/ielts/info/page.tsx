      ...
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-blue-50 to-purple-50">
        ...
        <div className="container mx-auto py-12 px-4">
          ...
          <div id="packages" className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-3xl p-8 mb-16">
            <div className="text-center">
              <h3 className="text-4xl font-bold text-gray-800 mb-4">Choose Your Subscription Plan</h3>
              <p className="text-xl text-gray-600 mb-8">
                Get access to IELTS prep and all premium features with our comprehensive subscription plans
              </p>

        ...
        <div className="container mx-auto py-12 px-4">
                              ...
                              {activeTab === "mock" && (
                                <div className="bg-blue-50 p-4 rounded-lg border border-blue-200 mb-6">
                                  <p className="text-blue-700 text-sm font-medium">
                                    📝 This is a full paper mock exam. Write
                                    your answers on paper or in your preferred
                                    format.
                                  </p>
                                  <div className="mt-2 text-xs text-blue-600">
                                    ...
                                    <p>
                                      • Use appropriate examples and evidence
                                    </p>
                                    <p>
          ...
          <Dialog open={showFeedback} onOpenChange={setShowFeedback}>
            <DialogContent className="max-w-md text-center bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl">
              ...
              />
              Failed to compile Next.js (14.2.16) is outdated (learn more)
              ./node_modules/framer-motion/dist/es/index.mjs Error: It's
              currently unsupported to use "export *" in a client boundary.

        ...
        <div className="mb-4">
          <div className="flex items-center bg-yellow-50 border-l-4 border-yellow-400 p-3 rounded">
            ...
            <span className="text-yellow-800 text-sm">
              Cheating Prevention: Tab switching, copy, paste, and right-click
              are disabled. Multiple tab switches will auto-submit your exam.
            </span>
          </div>
        </div>
        {/* Tab Switch Warning */}
          ...
          <div className="mb-4">
            <div className="flex items-center bg-red-50 border-l-4 border-red-400 p-3 rounded">
              ...
              <span className="text-red-800 text-sm font-semibold">
                Tab switch detected! Please do not leave or switch tabs during
                the assessment.
              </span>
            </div>
          </div>
        ...
        <div className="flex justify-between items-center mt-8">
          ...
          {current < assessment.mcqs.length - 1 ? (
            <Button
              ...
              onClick={() =>
                setCurrent((c) => Math.min(assessment.mcqs.length - 1, c + 1))
              }
            >
              Next
            </Button>

...
const subjectCategories = [
  ...
  },
  {
    id: "medicine",
    title: "Medicine",
    description: "Anatomy, Physiology, Pathology and more",
    icon: Stethoscope,
    color: "red",
    gradient: "from-red-500 to-pink-500",
  ...
  },
  {
    id: "business",
    title: "Business",
    description: "Business Management, Marketing, HR and more",
    icon: Building2,
    color: "blue",
    gradient: "from-blue-500 to-cyan-500",
    bgGradient: "from-blue-50 to-cyan-50",
  ...
  },
  {
    id: "law",
    title: "Law",
    description: "Constitutional Law, Criminal Law, Civil Law and more",
    icon: Scale,
    color: "gray",
    gradient: "from-gray-500 to-slate-500",

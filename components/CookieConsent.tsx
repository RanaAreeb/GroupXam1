...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-[9999] w-[95vw] max-w-xl bg-gradient-to-r from-emerald-700/80 via-blue-700/80 to-purple-700/80 backdrop-blur-2xl border border-emerald-400/40 rounded-2xl shadow-2xl px-6 py-5 flex flex-col sm:flex-row items-center gap-4 animate-slide-down">
